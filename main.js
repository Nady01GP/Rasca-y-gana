...
this.load.image("Perla","../img/Perla.png");
this.load.image("Zafiro","../img/Zafiro.png");
this.load.image("Opalo","../img/Opalo.png");
this.load.image("Nada","../img/Nada.png");
}
...
this.premios=["Perla","Zafiro","Opalo","Nada"];
this.resultados=[];
this.tarjetas=[];
this.descubiertas=0;
